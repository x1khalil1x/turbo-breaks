...
const CAMERA_SPEED = 250.0  # Slightly slower for precise top-down navigation
const ZOOM_SPEED = 0.2
const MIN_ZOOM = 1.0        # Closer min for detail work
const MAX_ZOOM = 6.0        # Higher max for overview
